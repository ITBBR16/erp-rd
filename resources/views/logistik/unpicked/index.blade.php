...
@section('container')
    ...
    <form action="{{ route('list-unpicked.store') }}" method="POST" autocomplete="off">
        @csrf
        <div class="grid grid-row-2 gap-x-6 gap-y-4">
            {{-- List --}}
            <div class="relative p-4">
                <h3 class="text-gray-900 font-semibold text-xl dark:text-white mb-2">List Pick Up / Input No Resi :</h3>
                <div class="overflow-y-auto max-h-[450px] border rounded-lg shadow-md">
            ...
            {{-- Form --}}
            <div class="relative p-4 border rounded-md shadow-lg border-gray-200 bg-white dark:bg-gray-700 dark:border-gray-600">
                <h3 class="text-gray-900 font-semibold text-xl dark:text-white">Form Pick Up / Input No Resi : </h3>
                <div class="grid grid-cols-5 my-4" style="grid-template-columns: 2fr 5fr 2fr 5fr 5fr">
                    ...
                    <div class="text-start">
                        <select name="option_jenis_form" id="option-jenis-form" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    ...
                    <div class="text-start">
                        <select name="option_ekspedisi" id="option-ekspedisi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
