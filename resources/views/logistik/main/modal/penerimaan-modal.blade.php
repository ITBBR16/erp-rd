                ...
                <div class="px-6 py-6 lg:px-8">
                    <form action="{{ route('penerimaan.update', $item->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="relative z-0 w-full items-center py-2">
                            <input type="file" name="file_upload" id="small_size" class="block w-full text-xs text-gray-900 rounded-lg cursor-pointer dark:text-gray-400 focus:outline-none dark:placeholder-gray-400">
                        </div>
