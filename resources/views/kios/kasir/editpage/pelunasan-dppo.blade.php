        ...
        <div class="col-span-2 my-4">
            <div class="flex items-center justify-between mb-4 pb-2 border-b-2">
                <div class="flex justify-start">
                    <p class="text-base font-semibold text-gray-900 dark:text-white">Current Date : <span class="text-gray-900 font-normal dark:text-white">{{ $dataTransaksi->created_at->format('d/m/Y') }}</span></p>
                </div>
            ...
            <div class="grid grid-cols-2 w-full gap-6 mb-4">
                ...
                <div>
                    ...
                    <select name="dppo_nama_customer" id="dppo_nama_customer" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        ...
                        <option value="{{ $dataTransaksi->customer_id }}" selected>{{ $dataTransaksi->customer->first_name }} {{ $dataTransaksi->customer->last_name }}</option>
                    </select>
                </div>
            </div>
            ...
            <div class="w-80 text-base bg-white p-4 text-white border-0 border-transparent border-solid shadow-xl rounded-2xl bg-clip-border dark:bg-gray-800 dark:border-gray-600">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex justify-end ml-auto">
                        <p id="dppo-box-subtotal" class="text-gray-900 font-normal dark:text-white">Rp. {{ number_format($dataTransaksi->total_harga, 0, ',', '.') }}</p>
                    </div>
                </div>
                <div class="flex items-center justify-between border-b-2">
                    ...
                    <div class="flex justify-end ml-auto">
                        <p id="dppo-box-dp" class="text-gray-900 font-normal dark:text-white">Rp. {{ number_format($dataTransaksi->transaksidp->jumlah_pembayaran, 0, ',', '.') }}</p>
                    </div>
                </div>
                <div class="flex items-center justify-between mt-2">
                    ...
                    <div class="flex justify-end ml-auto">
                        ...
                        @endphp
                        <p id="dppo-box-total" class="text-gray-900 font-normal dark:text-white">Rp. {{ number_format($totalNilai, 0, ',', '.') }}</p>
                    </div>
                </div>
            ...
            <tbody id="kasir-container">
                @foreach ($dataTransaksi->detailtransaksi as $index => $detail)
                    <tr id="kasir-item-{{ $index }}" class="bg-white dark:bg-gray-800">
                        ...
                        <td class="px-4 py-4">
                            <input type="hidden" name="item_id[]" id="item-id-{{ $index }}" class="item_id bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Item Name" required>
