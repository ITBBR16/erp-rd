<div id="pelunasan-invoice" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                ...
                <div class="px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10">
                    <div class="mx-auto">
                            ...
                            <div id="print-invoice-kios" class="text-xs" style="max-width: 210mm;">
                                    ...
                                    <div class="text-end">
                                        <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                                            <dl class="grid sm:grid-cols-5 gap-x-3">
                                                ...
                                                <dd class="col-span-1 text-gray-500">{{ $dataTransaksi->created_at->format('Ymd') }}{{ $dataTransaksi->id }}</dd>
                                            </dl>
                                            <dl class="-mt-1 grid sm:grid-cols-5 gap-x-3">
                                                <dt class="col-span-4 font-semibold text-gray-800 dark:text-gray-200">Tanggal Pembelian:</dt>
                                ...
                                <div class="relative overflow-x-auto pt-4">
                                    <table class="border text-xs w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody id="invoice-pelunasan-container">
                        ...
                        <div class="p-4 flex justify-end gap-x-3">
                            ...
                            <button type="submit" name="status_pelunasan" value="Done" form="pelunasan-dppo-form" class="submit-button-form text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">Submit</button>
