...
@section('container')
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($dataHistory as $item)
                        ...
                        <!-- Dropdown menu -->
                        <div id="dropdownLHT{{ $item->id }}" class="z-10 hidden bg-white rounded-lg shadow w-40 dark:bg-gray-700">
                            <ul class="h-auto py-2 text-gray-700 dark:text-gray-200" aria-labelledby="dropdownListHistoryTransaksi{{ $item->id }}">
                                <li>
                                    <button type="button" data-modal-target="detail-history-{{ $item->id }}" data-modal-toggle="detail-history-{{ $item->id }}" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
    ...
    {{-- Modal --}}
    @include('kios.kasir.modal.detail-history')
