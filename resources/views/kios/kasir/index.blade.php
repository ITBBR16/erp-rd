...
@section('container')
    ...
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="kasirTab" data-tabs-toggle="#kasirTabContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="new-kasir-tab" data-tabs-target="#new-kasir" type="button" role="tab" aria-controls="new-kasir" aria-selected="false">New Kasir</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="list-hold-tab" data-tabs-target="#list-hold" type="button" role="tab" aria-controls="list-hold" aria-selected="false">List Hold Kasir</button>
            </li>
        </ul>
    </div>
    ...
    <div class="kasirTabContent">
        @include('kios.kasir.tabs.new-kasir')
        @include('kios.kasir.tabs.list-hold-kasir')
    </div>
