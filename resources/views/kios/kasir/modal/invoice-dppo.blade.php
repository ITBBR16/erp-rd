<div id="dppo-invoice" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        ...
                        <div class="text-xs flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl dark:bg-gray-800">
                            <div id="print-invoice-kios" class="text-xs" style="max-width: 210mm;">
                                <div class="flex justify-between">
                                    ...
                                    <div class="text-end">
                                        <h2 id="invoice-title" class="text-xl md:text-2xl font-semibold text-gray-800 dark:text-gray-200"></h2>
                                    ...
                                    <div>
                                        <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                                            <dl class="grid grid-cols-3">
                                                ...
                                                <dd id="dppo-invoice-nama-customer" class="col-span-2 text-gray-500"></dd>
                                            </dl>
                                            <dl class="-mt-1 grid grid-cols-3">
                                                <dt class="col-span-1 font-semibold text-gray-800 dark:text-gray-200">No Tlp:</dt>
                                                <dd id="dppo-invoice-no-tlp" class="col-span-2 text-gray-500"></dd>
                                            </dl>
                                            <dl class="-mt-1 grid grid-cols-3">
                                                <dt class="col-span-1 font-semibold text-gray-800 dark:text-gray-200">Alamat:</dt>
                                                <dd id="dppo-invoice-jalan" class="col-span-2 text-gray-500"></dd>
                                            </dl>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                ...
                                <div class="relative overflow-x-auto pt-4">
                                    <table class="border text-xs w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody id="invoice-dppo-container">
                                        ...
                                        <div class="text-sm w-full max-w-2xl sm:text-end">
                                            <div class="grid grid-cols-2 sm:grid-cols-1 gap-1">
                                                <dl class="grid sm:grid-cols-5 gap-x-3">
                                                    ...
                                                    <dd id="invoice-dppo-subtotal" class="col-span-3 text-gray-500"></dd>
                                                </dl>
                                                <dl class="grid sm:grid-cols-5 gap-x-3">
                                                    <dt class="col-span-2 font-semibold text-gray-800 dark:text-gray-200">DP:</dt>
                                                    <dd id="invoice-dppo-dp" class="col-span-3 text-gray-500"></dd>
                                                </dl>
                                                <dl class="grid sm:grid-cols-5 gap-x-3 border-b-2 dark:border-white">
                                                    
                                                </dl>
                                                <dl class="grid sm:grid-cols-5 gap-x-3">
                                                    <dt class="col-span-2 font-semibold text-gray-800 dark:text-gray-200">Sisa Total:</dt>
                                                    <dd id="invoice-dppo-sisa-total" class="col-span-3 text-gray-500"></dd>
                                                </dl>
                                            </div>
                                        </div>
                                    </div>
