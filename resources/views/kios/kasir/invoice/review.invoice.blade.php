...
<body>
            ...
            <td style="width: 66%; vertical-align: top;">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="color: #6B7280;">{{ $dataTransaksi->customer->first_name }} {{ $dataTransaksi->customer->last_name ?? '' }}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 600; color: #1F2937;">No Tlp:</td>
                        <td style="color: #6B7280;">{{ $dataTransaksi->customer->no_telpon }}</td>
                    </tr>
                    <tr>
                        <td style="font-weight: 600; color: #1F2937;">Alamat:</td>
                        <td style="color: #6B7280;">{{ $dataTransaksi->customer->nama_jalan }}</td>
                    </tr>
                </table>
            </td>
    ...
    <div style="position: relative; padding-top: 1rem; font-size: 12px;">
        <table style="border: 1px solid; width: 100%; text-align: left; color: #6B7280;">
            ...
            <tbody>
                @foreach ($dataTransaksi->detailtransaksi as $detail)
                    <tr>
                        <td style="padding: 0.25rem; font-size: 12px;"></td>
                        <td style="padding: 0.25rem; font-size: 12px;"></td>
                        <td style="padding: 0.25rem; font-size: 12px;"></td>
                        <td style="padding: 0.25rem; font-size: 12px;"></td>
                        <td style="padding: 0.25rem; font-size: 12px;"></td>
