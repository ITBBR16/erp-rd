...
@section('container')
    ...
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="dppoTab" data-tabs-toggle="#dppoTabContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="list-dppo-tab" data-tabs-target="#list-dppo" type="button" role="tab" aria-controls="list-dppo" aria-selected="false">Lists DP / PO</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="new-dppo-tab" data-tabs-target="#new-dppo" type="button" role="tab" aria-controls="new-dppo" aria-selected="false">New DP / PO</button>
            </li>
        </ul>
    </div>
    ...
    <div class="dppoTabContent">
        @include('kios.kasir.tabs.list-dppo')
        @include('kios.kasir.tabs.new-dppo')
    </div>
