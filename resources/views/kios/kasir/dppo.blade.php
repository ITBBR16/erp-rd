        ...
        <div class="grid grid-cols-3 w-full">
            <div class="col-span-2 my-4">
                ...
                <div class="my-4 pt-2 border-t-2 text-center justify-center">
                    <p class="text-lg font-bold text-black dark:text-white">DP / PO</p>
                </div>
                <div class="grid grid-cols-2 w-full gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" name="dppo_discount" id="dppo-nominal" class="kasir-formated-rupiah rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0" oninput="this.value = this.value.replace(/\D/g, '')">
                        </div>
                    </div>
                </div>
            </div>
