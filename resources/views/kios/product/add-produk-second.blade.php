...
@section('container')
    ...
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="addPS" data-tabs-toggle="#addPSTabContent" role="tablist">
            ...
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="createPaket-tab" data-tabs-target="#createPaket" type="button" role="tab" aria-controls="createPaket" aria-selected="false">Buat Paket Penjualan Second</button>
            </li>
        </ul>
    </div>
