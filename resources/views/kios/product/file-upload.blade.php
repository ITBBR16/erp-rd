    ...
    <form action="#" method="POST" autocomplete="off" enctype="multipart/form-data" class="mt-6">
        ...
        <div class="w-10/12">
            <div class="grid grid-cols-2 gap-4 md:gap-6">
                <label for="fu_nama_produk" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Select Customer :</label>
                <div class="relative z-0 w-full mb-6 group">
                    <select name="fu_nama_produk" id="fu_nama_produk" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
            ...
            <div class="grid grid-cols-2 gap-4 md:gap-6">
                <label for="file_paket_produk" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">File Jenis Produk :</label>
            ...
            <div class="grid grid-cols-2 gap-4 md:gap-6 mt-4">
                <label for="file_kelengkapan_produk" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Files Kelengkapan :</label>
                <div class="flex items-center justify-center w-full">
                    <label for="file_kelengkapan_produk" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                            </svg>
