...
@section('container')
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="fileUpload" data-tabs-toggle="#fileUploadContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="file-new-tab" data-tabs-target="#file-new" type="button" role="tab" aria-controls="file-new" aria-selected="false">Upload File Produk Baru</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="file-second-tab" data-tabs-target="#file-second" type="button" role="tab" aria-controls="file-second" aria-selected="false">Upload File Produk Second</button>
            </li>
        </ul>
    </div>
    ...
    <div id="fileUpload">
        @include('kios.product.tabs.file-upload-baru')
        @include('kios.product.tabs.file-upload-second')
    </div>
