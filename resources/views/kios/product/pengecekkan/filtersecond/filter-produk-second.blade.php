...
@section('container')
    ...
    <form action="{{ route('filter-product-second.update', $kos->qcsecond->id) }}" method="POST" autocomplete="off">
        ...
        <div class="flex justify-between items-center p-5 bg-white dark:bg-gray-800">
            <!-- Caption di kiri -->
            <div class="flex flex-col">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Cek Kelengkapan</h2>
                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                    Pastikan memasukkan hasil quality control sesuai.
                </p>
            </div>
            <!-- Inputan di kanan -->
            <div class="flex gap-4 mt-4">
                <div class="relative z-0 group flex items-center">
                    <span class="absolute start-0 font-bold text-gray-500 dark:text-gray-400">RP</span>
                    <input type="text" name="biaya_ambil" id="biaya-ambil-filter"
                        class="block py-2.5 ps-8 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " value="{{ number_format($kos->biaya_pembelian, 0, ',', '.') }}" readonly>
                    <label for="biaya-ambil-filter"
                        class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-placeholder-shown:start-8 peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
                        Biaya Ambil
                    </label>
                </div>
                <div class="relative z-0 group flex items-center">
                    <span class="absolute start-0 font-bold text-gray-500 dark:text-gray-400">RP</span>
                    <input type="text" name="biaya_cek_filter" id="biaya-cek-filter"
                        class="block pt-2.5 ps-8 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " readonly>
                    <label for="biaya-cek-filter"
                        class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-placeholder-shown:start-8 peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
                        Biaya Cek Filter
                    </label>
                </div>
