...
@section('container')
    ...
    <form action="{{ route('pengecekkan-produk-second.update', $kos->qcsecond->id) }}" method="POST" autocomplete="off">
        ...
        <input type="hidden" name="order_second_id" value="{{ $kos->id }}">
        <input type="hidden" name="customer_id" value="{{ $kos->customer->id }}">
        {{-- <div class="w-10/12 my-6">
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="qc_supplier" id="qc_supplier" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ $kos->customer->first_name . ' ' . $kos->customer->last_name }}" readonly>
                ...
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    <select name="status_qc_second" id="status_qc_second" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                    ...
                    @foreach ($kos->qcsecond->kelengkapans as $index => $kelengkapan)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <select name="kondisi[]" id="kondisi" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required>
