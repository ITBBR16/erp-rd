        ...
        <div class="w-10/12 my-6">
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="qc_supplier" id="qc_supplier" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('qc_supplier') border-red-600 dark:border-red-500 @enderror" placeholder="" value="{{ $kos->customer->first_name . ' ' . $kos->customer->last_name }}" readonly>
