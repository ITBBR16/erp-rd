        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-2">
                        <button id="dropdownQcSecondButton{{ $os->id }}" data-dropdown-toggle="dropdownQcSecond{{ $os->id }}" data-dropdown-placement="bottom" class="text-gray-500 border border-gray-300 font-bold rounded-lg text-sm p-2 w-32 text-start inline-flex items-center dark:text-gray-300 dark:border-gray-300" type="button">Atur <svg class="w-2.5 h-2.5 ms-16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                            </svg>
                        </button>
                        <!-- Dropdown menu -->
                        <div id="dropdownQcSecond{{ $os->id }}" class="z-10 hidden bg-white rounded-lg shadow w-40 dark:bg-gray-700">
                            <ul class="h-auto py-2 text-gray-700 dark:text-gray-200" aria-labelledby="dropdownQcSecondButton{{ $os->id }}">
                                <li>
                                    <a href="{{ route('pengecekkan-produk-second.quality-control', encrypt($os->id)) }}" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
                                        <i class="material-symbols-outlined text-xl mr-3">search_check</i>
                                        <span class="whitespace-nowrap">QC Produk</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
    ...
    @if (!$orderSecond->contains('status', 'Proses QC'))
        <div class="p-4 mt-4 flex justify-center items-center">
            <figure class="max-w-lg">
                <img class="h-auto ml-8 max-w-full rounded-lg" src="/img/empty.png" alt="Not Found" width="150" height="10">
                <figcaption class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">Belum ada data untuk quality control</figcaption>
            </figure>
        </div>
    @endif
