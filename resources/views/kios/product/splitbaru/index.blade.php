...
@section('container')
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="addKelengkapan" data-tabs-toggle="#addKelengkapanContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="listKelengkapan-tab" data-tabs-target="#listKelengkapan" type="button" role="tab" aria-controls="listKelengkapan" aria-selected="false">List Kelengkapan</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="splitProduk-tab" data-tabs-target="#splitProduk" type="button" role="tab" aria-controls="splitProduk" aria-selected="false">Split Produk</button>
            </li>
            <li class="mr-2" role="presentation">
    ...
    {{-- Tabs --}}
    <div class="addKelengkapanContent">
