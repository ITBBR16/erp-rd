<div class="hidden p-4" id="createBnob" role="tabpanel" aria-labelledby="createBnob-tab">
                ...
                <div class="rounded-lg shadow-md border bg-white p-4">
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <div x-data="paketPenjualanBnob()" class="relative col-span-2 text-start">
                                <div class="relative">
                                    ...
                                    <input type="hidden" id="paket-penjualan-bnob" name="paket_penjualan_bnob" :value="selected" required>
                                </div>
                        ...
                        <div>
                            <label for="harga-srp" class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Nominal Harga Jual :</label>
                    ...
                    <div id="kelengkapan-split-baru" class="relative mt-6">
                        
                    </div>
                    <div class="flex justify-between text-rose-600">
                        <div class="flex cursor-pointer mt-4 hover:text-red-400">
                            <button type="button" id="add-kelengkapan-split" class="flex flex-row justify-between gap-2">
                ...
                <div class="rounded-lg shadow-md border bg-white p-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex justify-start">
                            <p class="font-semibold text-gray-900 dark:text-white">Total Modal :</p>
                        </div>
                        <div class="flex justify-end ml-auto">
                            <input type="hidden" name="total_modal_bnob" id="total-modal-bnob">
                            <p id="total-modal-box-bnob" class="text-gray-900 font-normal dark:text-white">Rp. 0</p>
                        </div>
                    </div>
                    <div class="flex items-center justify-between mt-2">
                        <div class="flex justify-start">
                            <p class="font-bold text-lg text-purple-600 dark:text-white">Harga Jual :</p>
                        </div>
                        <div class="flex justify-end ml-auto">
                            <p id="harga-srp-bnob" class="text-purple-600 text-lg font-bold dark:text-white">Rp. 0</p>
                        </div>
                    </div>
                </div>
                <div>
    ...
    <script>
        function paketPenjualanBnob() {
            return {
                open: false,
                search: '',
                selected: '',
                jenis: Object.values(@json($dataBnob)),
                filteredJenis: [],
                debounceSearch: null,
                init() {
