        ...
        <div class="w-10/12">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full group">
                    ...
                    <input type="text" name="no_customer_second" id="no_customer_second" class="block py-2.5 ps-8 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('no_customer_second') border-red-600 dark:border-red-500 @enderror" placeholder=" " oninput="this.value = this.value.replace(/\D/g, '')">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <input type="hidden" name="produk_jenis_id" id="produk-jenis-id">
