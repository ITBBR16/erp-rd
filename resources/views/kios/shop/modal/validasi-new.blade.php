            ...
            <div class="relative w-full max-w-xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-xl font-medium text-gray-900 dark:text-white">Validasi Order N.{{ $item->id }}</h3>
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <form action="{{ route('shop.update', $item->id) }}" method="POST" autocomplete="off">
                            ...
                            <div id="form-validasi-{{ $item->id }}">
                                @foreach ($item->orderLists as $ol)
                                    <div id="container-form-validasi-{{ $ol->id }}" class="container-form-val">
                                        <div class="grid grid-cols-4 mb-4 gap-4" style="grid-template-columns: 5fr 2fr 4fr 1fr">
                                            <div class="relative z-0 w-full group">
                                                <select name="jenis_paket[]" id="jenis-paket{{ $ol->id }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600" required>
