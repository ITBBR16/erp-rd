@foreach ($payment as $validasiPayment)
    @if ($validasiPayment->status == 'Unpaid')
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        <h3 class="mb-4 font-semibold text-gray-900 dark:text-white">Daftar Penjual</h3>
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" name="media_transaksi" id="media_transaksi{{ $validasiPayment->id }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ ($validasiPayment->order_type == 'Baru' && $validasiPayment->metodepembayaran) ? $validasiPayment->metodepembayaran->akunBank->nama : (($validasiPayment->order_type == 'Bekas' && $validasiPayment->metodepembayaransecond) ? $validasiPayment->metodepembayaransecond->akunBank->nama : '') ?? '' }}" readonly required>
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" name="no_rek" id="no_rek{{ $validasiPayment->id }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ ($validasiPayment->order_type == 'Baru' && $validasiPayment->metodepembayaran) ? $validasiPayment->metodepembayaran->no_rek : (($validasiPayment->order_type == 'Bekas' && $validasiPayment->metodepembayaransecond) ? $validasiPayment->metodepembayaransecond->no_rek : '') ?? '' }}" readonly required>
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="nama_akun" id="nama_akun{{ $validasiPayment->id }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ ($validasiPayment->order_type == 'Baru' && $validasiPayment->metodepembayaran) ? $validasiPayment->metodepembayaran->nama_akun : (($validasiPayment->order_type == 'Bekas' && $validasiPayment->metodepembayaransecond) ? $validasiPayment->metodepembayaransecond->nama_akun : '') ?? '' }}" readonly required>
