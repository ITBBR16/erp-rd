        ...
        <div class="relative w-full max-w-xl max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-medium text-gray-900 dark:text-white">Req Payment Order K.{{ $validasiPayment->order->id }}</h3>
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form action="{{ route('form-validasi-payment', ['id' => $validasiPayment->id]) }}" method="POST" autocomplete="off">
                        @csrf
                        <input type="hidden" name="order_id" id="order_id" value="{{ $validasiPayment->order->id }}">
                        <div class="grid md:grid-cols-2 md:gap-6 pt">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="supplier_kios" id="supplier_kios" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ $validasiPayment->order->supplier->nama_perusahaan }}" readonly required>
                            ...
                            @enderror
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="invoice" id="invoice" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ $validasiPayment->order->invoice }}" readonly required>
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="nama_akun" id="nama_akun" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('nama_akun') border-red-600 dark:border-red-500 @enderror" placeholder="" value="{{ $validasiPayment->metodepembayaran->nama_akun ?? '' }}" readonly required>
                        ...
                        <div class="grid grid-cols-3 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="nilai_belanja" id="nilai_belanja" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('nilai_belanja') border-red-600 dark:border-red-500 @enderror" placeholder="" value="Rp. {{ number_format($validasiPayment->nilai, 0, ',', '.') }}" readonly required>
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="ongkir" id="ongkir" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('ongkir') border-red-600 dark:border-red-500 @enderror" placeholder="" value="Rp. {{ number_format($validasiPayment->ongkir, 0, ',', '.') }}" readonly>
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="pajak" id="pajak" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('pajak') border-red-600 dark:border-red-500 @enderror" placeholder="" value="Rp. {{ number_format($validasiPayment->pajak, 0, ',', '.') }}" readonly>
