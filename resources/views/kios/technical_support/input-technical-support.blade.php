...
@section('container')
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="tsTabs" data-tabs-toggle="#tsTabsContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="ts-terdata-tab" data-tabs-target="#ts-terdata" type="button" role="tab" aria-controls="ts-terdata" aria-selected="false">Data Technical Support</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="its-tab" data-tabs-target="#its" type="button" role="tab" aria-controls="its" aria-selected="false">Input Technical Support</button>
            </li>
        </ul>
    </div>
    ...
    <div class="tsTabsContent">
        @include('kios.technical_support.tabs-input-ts.sudah-terdata')
        @include('kios.technical_support.tabs-input-ts.belum-terdata')
    </div>
