                ...
                <div class="px-6 py-6 lg:px-8">
                    <form action="#" method="POST" autocomplete="off">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <label for="status_supplier" class="sr-only">Status Supplier</label>
                                <select name="status_supplier" id="status_supplier" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('status_supplier') border-red-600 dark:border-red-500 @enderror">
                                    <option hidden>Status Supplier</option>
                                    <option class="dark:bg-gray-700">Product Baru</option>
                                    <option class="dark:bg-gray-700">Product Second</option>
                                </select>
