<div class="hidden p-4" id="history-pengiriman" role="tabpanel" aria-labelledby="history-pengiriman-tab">
    <div class="relative overflow-x-auto">
        <div class="flex items-center py-4">
            <label for="search-pengiriman-history" class="sr-only">Search</label>
            <div class="relative">
                ...
                <input type="text" id="search-pengiriman-history" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-52 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Items">
            </div>
        </div>
    </div>
