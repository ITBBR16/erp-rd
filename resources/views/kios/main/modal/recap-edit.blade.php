                ...
                <div class="px-6 py-6 lg:px-8">
                    <form action="{{ route('daily-recap.update', $dr->id) }}" method="POST">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="edit_link_permasalahan" id="edit_link_permasalahan" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" value="{{ $dr->permasalahan->link_permasalahan }}" readonly>
