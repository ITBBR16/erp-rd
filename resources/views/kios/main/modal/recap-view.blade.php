@foreach ($dailyRecap as $dr)
    <div id="recap-view{{ $dr->id }}" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <div class="grid-rows-2">
                        ...
                        <h3 class="text-base text-gray-900 dark:text-white">{{ $dr->keterangan }}</h3>
                    </div>
                </div>
            </div>
        </div>
