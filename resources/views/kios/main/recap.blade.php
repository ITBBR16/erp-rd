...
<div class="mb-4 border-b border-gray-200">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="drTab" data-tabs-toggle="#drTabContent" role="tablist">
        ...
        <li class="mr-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="new-customer-tab" data-tabs-target="#new-customer" type="button" role="tab" aria-controls="new-customer" aria-selected="false">New Customer</button>
        </li>
    </ul>
</div>
