<div class="hidden p-4" id="dbl" role="tabpanel" aria-labelledby="dbl-tab">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white border-b hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-2">
                        <span class="bg-orange-400 rounded-md px-2 py-0 text-white">TMR</span>
                    </td>
                    <td class="px-6 py-2">
                ...
                <tr class="bg-white border-b hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4">
                        <span class="bg-green-400 rounded-lg px-2 py-0 text-white">RECEIVED</span>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex flex-wrap">
                            <button type="button" class="text-gray-400 hover:text-gray-800 mx-2 dark:hover:text-gray-300">
    ...
    {{-- Modal Delete --}}
    <div id="delete-belanja" tabindex="-1" class="fixed top-0 left-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[cal(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-md max-h-full">
            <div class="flex flex-col p-8 bg-white shadow-md hover:shodow-lg rounded-2xl dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-16 h-16 rounded-2xl p-3 border border-blue-100 text-blue-400 bg-blue-50 dark:border-gray-800 dark:bg-gray-900" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <div class="flex flex-col ml-3">
                            <div class="font-medium leading-none dark:text-gray-100">Hapus Daftar Belanja ?</div>
                            <p class="text-sm text-gray-600 leading-none mt-1 dark:text-gray-500">Data belanja akan terhapus permanen</p>
                        </div>
                    </div>
                    <button  class="flex-no-shrink bg-red-500 px-5 ml-4 py-2 text-sm shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-red-500 text-white rounded-full" data-modal-hide="delete-belanja">Delete</button>
                </div>
            </div>
        </div>
    </div>
