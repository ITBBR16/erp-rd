...
@section('container')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li class="flex items-center">
                <a href="{{ route('gudang-qc.index') }}" class="flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                    <span class="material-symbols-outlined w-5 h-5">tune</span>
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Check Fungsional Sparepart N.{{ $idBelanja }}</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <form action="{{ route('storeFungsional') }}" method="POST" autocomplete="off">
        @csrf
        <div class="relative my-4">
            <div class="flex items-center justify-between">
                <div class="flex text-xl justify-start">
                    <span class="text-gray-700 font-semibold dark:text-gray-300">List QC Fungsional</span>
                </div>
        ...
        <div class="relative">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($dataCekFungsional as $item)
                        <tr class="bg-white border-b border-gray-200 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-2">
                                <select name="cek_fungsional[]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
