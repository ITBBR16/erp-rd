...
@section('container')
                ...
                <tr class="bg-white border-b hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-2">
                        <div class="flex flex-wrap">
                            <button data-modal-target="resi-modal" data-modal-toggle="resi-modal" type="button" class="text-gray-400 hover:text-gray-800 mx-2 dark:hover:text-gray-300">
    ...
    {{-- Modal Input Resi --}}
    <div id="resi-modal" tabindex="-1" class="fixed top-0 left-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="resi-modal">
