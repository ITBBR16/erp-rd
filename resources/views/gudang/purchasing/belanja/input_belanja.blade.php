<div class="hidden p-4" id="belanja" role="tabpanel" aria-labelledby="belanja-tab">
    <form action="#" method="POST" autocomplete="off">
        <div class="grid grid-cols-3 gap-6">
            ...
            {{-- Bagian Kanan --}}
            <div class="col-span-1 h-[460px] bg-white p-6 rounded-lg border shadow-lg dark:bg-gray-800 dark:border-gray-600 sticky top-4">
                <h2 class="text-lg font-semibold mb-4 dark:text-white pb-2 border-b">Total Transaksi Belanja :</h2>
                ...
                <h2 class="text-lg font-semibold mb-4 dark:text-white border-y py-2">Akun Pembayaran Supplier :</h2>
