    ...
    <form>
        <div class="mb-6">
            <div class="relative z-0 w-full md:w-1/2 mb-6 group">
                <label for="select_customer_batt" class="sr-only"></label>
                <select id="select_customer_batt" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-white dark:border-gray-700 dark:bg-gray-800 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
