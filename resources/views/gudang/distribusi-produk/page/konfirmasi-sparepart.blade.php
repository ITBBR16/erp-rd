...
@section('container')
    <nav class="flex mt-6">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li class="flex items-center">
                <a href="{{ route('konfirmasi-pengiriman.index') }}" class="flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
    ...
    <form action="{{ route('konfirmasi-pengiriman.store') }}" method="POST" autocomplete="off">
        @csrf
        <div class="relative my-4">
            <div class="flex items-center justify-between">
                <div class="flex text-xl justify-start">
                    <span class="text-gray-700 font-semibold dark:text-gray-300">List Sparepart Request</span>
                </div>
