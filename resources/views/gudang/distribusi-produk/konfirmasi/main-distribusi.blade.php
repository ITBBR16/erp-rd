                ...
                @foreach ($repairCase as $case)
                    @if ($case->estimasi && $case->estimasi->estimasiPart->contains('tanggal_dikirim', ''))
                        <tr>
                            ...
                            <td class="px-6 py-2">
                                <button id="dropdownKonfirmasiSparepart" data-dropdown-toggle="dropdownKS" data-dropdown-placement="bottom" class="text-gray-500 border border-gray-300 font-bold rounded-lg text-sm p-2 w-32 text-start inline-flex items-center dark:text-gray-300 dark:border-gray-300" type="button">
                                    Atur
                        ...
                        <!-- Dropdown menu -->
                        <div id="dropdownKS" class="z-10 hidden bg-white rounded-lg shadow w-40 dark:bg-gray-700">
                            <ul class="h-auto py-2 text-gray-700 dark:text-gray-200" aria-labelledby="dropdownKonfirmasiSparepart">
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('konfirmasi-pengiriman.edit', encrypt($case->id)) }}" target="_blank" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
