...
@section('container')
        ...
        <div class="flex items-center justify-between py-4">
            <div class="flex flex-row gap-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search_list_produk_gudang" id="search-list-produk-gudang" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-52 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search. . .">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="productTable">
        @include('gudang.produk.list-produk.partial.partial-list-produk')
    </div>
