...
@section('container')
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="splitTab" data-tabs-toggle="#splitTabContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg" id="split-tab" data-tabs-target="#split" type="button" role="tab" aria-controls="split" aria-selected="false">Split SKU</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="history-split-tab" data-tabs-target="#history-split" type="button" role="tab" aria-controls="history-split" aria-selected="false">History Split SKU</button>
            </li>
        </ul>
    </div>
    ...
    <div id="splitTabContent">
        @include('gudang.produk.split-sku.tabs.split-sku')
        @include('gudang.produk.split-sku.tabs.history-split')
    </div>
@endsection