                    ...
                    <div id="container-optional-split-part">
                        <div id="form-list-optional-split-1" class="form-list-optional-split grid grid-cols-5 gap-6" style="grid-template-columns: 5fr 5fr 3fr 3fr 1fr">
                            ...
                            <div>
                                ...
                                <select name="optional_sparepart[]" id="sparepart-optional-split-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="" hidden>Pilih Sparepart</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <div class="flex">
                                    <span class="inline-flex items-center px-3 text-base font-semibold text-gray-900 bg-gray-200 border rounded-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">Rp</span>
                                    <input type="text" name="optional_nominal_split[]" id="nominal-optional-split-1" data-id="0" class="format-angka-rupiah nominal-split-optional rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0">
                                </div>
                            </div>
                            <div>
                                <label for="qty-optional-split-1" class="block py-2 text-sm font-medium text-gray-900 dark:text-white">Quantity : </label>
                                <input type="text" name="optional_qty[]" id="qty-optional-split-1" data-id="0" class="number-format qty-split-optional bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0">
                            </div>
                        </div>
                    </div>
                </div>
