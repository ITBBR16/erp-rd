<div class="hidden p-4" id="adjust-stock" role="tabpanel" aria-labelledby="adjust-stock-tab">
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-between py-4">
            ...
            <div class="relative text-xl">
                <button type="button" data-modal-target="new-adjust-stock" data-modal-toggle="new-adjust-stock" class="flex text-indigo-600 hover:text-white border border-indigo-600 hover:bg-indigo-600 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-indigo-500 dark:text-indigo-500 dark:hover:text-white dark:hover:bg-indigo-500 dark:focus:ring-indigo-800">
                    <span class="material-symbols-outlined">contrast_circle</span>
                    <span class="ml-2"> Adjust Stock</span>
                </button>
            </div>
        </div>
    </div>
    ...
    {{-- Modal --}}
    @include('gudang.produk.adjust-stock.modal.adjust-modal')
</div>