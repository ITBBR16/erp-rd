...
@section('container')
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="adjustTab" data-tabs-toggle="#adjustTabContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg" id="adjust-stock-tab" data-tabs-target="#adjust-stock" type="button" role="tab" aria-controls="adjust-stock" aria-selected="false">Adjsut Stock</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="history-adjust-tab" data-tabs-target="#history-adjust" type="button" role="tab" aria-controls="history-adjust" aria-selected="false">History Adjust Stock</button>
            </li>
        </ul>
    </div>
    ...
    <div id="adjustTabContent">
        @include('gudang.produk.adjust-stock.tabs.adjust-stock')
        @include('gudang.produk.adjust-stock.tabs.history-adjust')
    </div>
