...
@section('container')
    ...
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-between py-4">
            <label for="rubah-estimasi-search" class="sr-only">Search</label>
            <div class="relative">
