...
@section('container')
    ...
    <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3 mt-4">
        ...
        <div class="p-4 border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            ...
            <form action="{{ route('konfirmasi-req-sparepart.store') }}" method="POST" autocomplete="off">
                @csrf
                <div class="grid grid-cols-2 gap-8 mb-6">
                    ...
                    <div class="relative">
                        <select name="status_konfirmasi" id="status-konfirmasi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            <option value="" hidden>Status Konfirmasi</option>
                            <option value="Estimasi">Lanjut Estimasi</option>
                            <option value="Pinjam">Pinjam Sparepart</option>
                        </select>
                    </div>
                </div>
                <h3 class="flex items-center mb-4 text-lg font-semibold text-gray-900 dark:text-white">
                ...
                <div class="relative">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody id="container-konf-req-part">
