...
@section('container')
    ...
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-between py-4">
            <label for="list-case-estimasi-search" class="sr-only">Search</label>
            <div class="relative">
    ...
    <div class="relative">
        <div class="overflow-y-auto max-h-[550px]">
            <table id="list-case-estimasi" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
