...
@section('container')
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="recapTransaksiTabs" data-tabs-toggle="#recapTransaksiTabsContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="recap-transaksi-tab" data-tabs-target="#recap-transaksi" type="button" role="tab" aria-controls="recap-transaksi" aria-selected="false">Recap Transaksi</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="hasil-recap-tab" data-tabs-target="#hasil-recap" type="button" role="tab" aria-controls="hasil-recap" aria-selected="false">Pencocokan Recap Transaksi</button>
            </li>
        </ul>
    </div>
    ...
    <div class="recapTransaksiTabs">
        @include('repair.csr.tabs.recap-transaksi')
        @include('repair.csr.tabs.recap-transaksi-hasil')
    </div>
