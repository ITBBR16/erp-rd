            ...
            <div class="relative w-full max-w-full max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8 bg-gray-50">
                        ...
                        <div class="border bg-white dark:border-gray-600 mt-4">
                            <h3 class="text-sm font-semibold dark:text-white pl-2 -translate-y-1/2">Kesimpulan</h3>
                            <textarea rows="4" class="block p-2.5 w-full text-sm text-gray-900 rounded-lg focus:ring-blue-500 border-none dark:placeholder-gray-400 dark:text-white" placeholder="Kesimpulan . . ." readonly>{{ $case->qualityControl->kesimpulan }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
