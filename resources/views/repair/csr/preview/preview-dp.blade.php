        ...
        <table style="width: 100%; padding-bottom: 8px; margin-bottom: 8px;">
            <tr>
                ...
                <td style="text-align: left; vertical-align: top; width: 50%;">
                    <h2 style="font-size: 8px; font-weight: 600; color: black;">Detail Transaksi / <span style="font-size: 8px; color: gray;">R-{{ $dataCase->id }} <span style="font-size: 6px; margin-left: 8px; color: #424242; background-color: #FFFDE7; padding: 4px 8px; border-radius: 9999px;">Down Payment</span></span></h2>
                </td>
                <!-- Kolom Kanan -->
            ...
            <tbody style="color: #374151;">
                @foreach ($dataCase->detailKelengkapan as $kelengkapan)
                    <tr style="border-top: 1px solid;">
                        ...
                        <td style="padding: 8px; text-align: center;">{{ $kelengkapan->quantity }}</td>
