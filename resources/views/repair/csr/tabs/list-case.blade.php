<div class="hidden p-4" id="listCase" role="tabpanel" aria-labelledby="listCase-tab">
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-between py-4">
            <label for="list-case-search" class="sr-only">Search</label>
            <div class="relative">
            ...
            <table id="list-case-csr" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="sticky top-0 text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Jenis Case</th>
                    ...
                    @foreach ($dataCase as $case)
                        ...
                        <div id="dropdownLC{{ $case->id }}" class="z-10 hidden bg-white rounded-lg shadow w-40 dark:bg-gray-700">
                            <ul class="h-auto py-2 text-gray-700 dark:text-gray-200" aria-labelledby="dropdownListCase{{ $case->id }}">
                                <li>
                                    <a href="{{ route('detailListCase', encrypt($case->id)) }}" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
                                ...
                                @if ($case->jenisStatus->jenis_status == 'New Case')
                                    <li>
                                        <a href="{{ route('case-list.edit', encrypt($case->id)) }}" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
