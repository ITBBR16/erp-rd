<div class="hidden p-4" id="listKasir" role="tabpanel" aria-labelledby="listKasir-tab">
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-between py-4">
            <label for="list-case-belum-lunas" class="sr-only">Search</label>
            <div class="relative">
    ...
    <div class="relative">
        <div class="overflow-y-auto max-h-[550px]">
            <table id="list-case-belum-lunas" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($dataCaseBelumLunas as $case)
                        ...
                        <!-- Dropdown menu -->
                        <div id="dropdownBL{{ $case->id }}" class="z-10 hidden bg-white rounded-lg shadow w-46 dark:bg-gray-700">
                            <ul class="h-auto py-2 text-gray-700 dark:text-gray-200" aria-labelledby="ddBelumLunas{{ $case->id }}">
                                ...
                                <li>
                                    <a href="{{ route('kasir-repair.edit', encrypt($case->id)) }}" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
                                ...
                                <li>
                                    <a href="{{ route('invoiceBuktiPembayaran', encrypt($case->id)) }}" target="_blank" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
                                        <i class="material-symbols-outlined text-base mr-3">receipt_long</i>
                                        <span class="whitespace-nowrap">Print Invoice</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
    ...
    {{-- Modal Kasir --}}
    @include('repair.csr.modal.konfirmasi-alamat')
