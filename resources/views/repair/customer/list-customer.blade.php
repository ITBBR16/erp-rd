...
@section('container')
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($dataCustomer as $dc)
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownCR{{ $dc->id }}" class="z-10 hidden bg-white rounded-lg shadow w-40 dark:bg-gray-700">
                        <ul class="h-auto py-2 text-gray-700 dark:text-gray-200" aria-labelledby="dropdownCustomerRepair{{ $dc->id }}">
                            <li>
                            ...
                            @if (auth()->user()->is_admin === 1 || auth()->user()->is_admin === 2)
                                <li>
                                    <button type="button" data-modal-target="update-customer{{ $dc->id }}" data-modal-toggle="update-customer{{ $dc->id }}" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
    ...
    <div id="dataCRNotFound" class="hidden p-4">
    ...
    @include('repair.customer.modal.view-customer')
    @include('repair.customer.modal.edit-customer')
    @include('repair.customer.modal.delete-customer')
