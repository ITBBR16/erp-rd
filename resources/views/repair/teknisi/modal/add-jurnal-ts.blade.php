                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form action="{{ route('troubleshooting.update', $case->id) }}" method="POST" autocomplete="off">
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <div class="mb-6">
                                <label for="keluhan-ts-{{ $case->id }}" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Keluhan</label>
                                <textarea id="keluhan-ts-{{ $case->id }}" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Keluhan . . ." disabled>{{ $case->keluhan }}</textarea>
                            </div>
                            <div class="mb-6">
