<div class="hidden p-4" id="allCase" role="tabpanel" aria-labelledby="allCase-tab">
                ...
                @foreach ($dataCase as $case)
                    ...
                    <div id="dropdownAC{{ $case->id }}" class="z-10 hidden bg-white rounded-lg shadow w-40 dark:bg-gray-700">
                        <ul class="h-auto py-2 text-gray-700 dark:text-gray-200" aria-labelledby="dropdownAllCase{{ $case->id }}">
                            <li>
                                <button type="button" data-modal-target="detail-all-case-{{ $case->id }}" data-modal-toggle="detail-all-case-{{ $case->id }}" class="flex w-full items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">
    ...
    {{-- Modal --}}
    @include('repair.teknisi.modal.detail-all-case')
</div>