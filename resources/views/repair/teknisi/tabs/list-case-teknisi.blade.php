<div class="hidden p-4" id="listCaseTeknisi" role="tabpanel" aria-labelledby="listCaseTeknisi-tab">
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-between py-4">
            <label for="list-case-teknisi-search" class="sr-only">Search</label>
            <div class="relative">
    ...
    <div class="relative">
        <div class="overflow-y-auto max-h-[550px]">
            <table id="list-case-teknisi" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    @if (auth()->user()->id == $case->teknisi_id)
                        ...
                        <!-- Dropdown menu -->
                        <div id="dropdownCL{{ $case->id }}" class="z-10 hidden bg-white rounded-lg shadow w-40 dark:bg-gray-700">
                            <ul class="h-auto py-2 text-gray-700 dark:text-gray-200" aria-labelledby="dropdownCaseList{{ $case->id }}">
                                <li>
