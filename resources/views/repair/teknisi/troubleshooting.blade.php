...
@section('container')
    ...
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-between py-4">
            <label for="list-case-ts-search" class="sr-only">Search</label>
            <div class="relative">
    ...
    <div class="relative">
        <div class="overflow-y-auto max-h-[550px]">
            <table id="list-case-ts" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($dataCase as $case)
                        @if ($case->jenisStatus->jenis_status == 'Proses Troubleshooting' && (auth()->user()->id == $case->teknisi_id || auth()->user()->id == 13))
