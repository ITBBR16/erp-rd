...
@section('container')
    <div class="mb-4 border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="caseListTeknisi" data-tabs-toggle="#caseListTeknisiContent" role="tablist">
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="listCaseTeknisi-tab" data-tabs-target="#listCaseTeknisi" type="button" role="tab" aria-controls="listCaseTeknisi" aria-selected="false">List Case Teknisi</button>
            </li>
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="allCase-tab" data-tabs-target="#allCase" type="button" role="tab" aria-controls="allCase" aria-selected="false">All Case</button>
            </li>
        </ul>
    </div>
    ...
    <div class="caseListTeknisiContent">
        @include('repair.teknisi.tabs.list-case-teknisi')
        @include('repair.teknisi.tabs.list-all-case')
    </div>
