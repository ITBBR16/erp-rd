...
<body class="bg-gray-1000 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white my-20 p-8 rounded-lg text-center border shadow-lg max-w-4xl lg:w-3/4">
        ...
        <form action="{{ route('review-customer.store') }}" method="POST" autocomplete="off">
            ...
            <input type="hidden" name="no_telpon" value="{{ $noIncrement }}">
            <div class="border-b-2">
                ...
                @if (session()->has('success'))
                    <div id="alert-success-input" class="flex items-center p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50" role="alert">
                        <span class="material-symbols-outlined flex-shrink-0 w-4 h-4">task_alt</span>
                        <div class="ml-3 mt-1 text-sm font-medium">
                            {{ session('success') }}
                        </div>
                        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex items-center justify-center h-8 w-8" data-dismiss-target="#alert-success-input" aria-label="Close">
                ...
                @if (session()->has('error'))
                    <div id="alert-failed-input" class="flex items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50" role="alert">
                        <span class="material-symbols-outlined flex-shrink-0 w-5 h-5">info</span>
                        <div class="ml-3 mt-1 text-sm font-medium">
                            {{ session('error') }}
                        </div>
                        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8" data-dismiss-target="#alert-failed-input" aria-label="Close">
                            <span class="sr-only">Dismiss</span>
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
            ...
            <div class="items-center justify-center my-4">
                ...
                <div class="grid grid-cols-3 mx-10 items-center justify-center my-4 space-x-2">
                    <div class="text-end">
                        <span class="text-gray-600 text-xs mt-2">Tidak Puas</span>
                    </div>
                    ...
                    <div class="text-start">
                        <span class="text-gray-600 text-xs mt-2">Sangat Puas</span>
                    </div>
                </div>
            </div>
            ...
            <div class="items-center justify-center my-4">
                ...
                <input type="text" name="kritik" class="block w-full mt-4 p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" placeholder="Kritik kepada kami . . ." required>
            </div>
    
            <div class="items-center justify-center my-4">
                <h3 class="text-base font-semibold">Saran agar kami bisa menjadi lebih baik</h3>
                <input type="text" name="saran" class="block w-full mt-4 p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" placeholder="Saran kepada kami . . ." required>
            </div>

            <div class="flex items-center justify-end pt-3 border-t border-gray-200 rounded-b">
                <button type="submit" class="submit-button-form text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Submit</button>
                <div class="loader-button-form" style="display: none">
                    <button class="cursor-not-allowed text-white border border-blue-700 bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" disabled>
