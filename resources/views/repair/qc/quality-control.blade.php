...
@section('container')
    ...
    <div class="relative overflow-x-auto">
        <div class="flex items-center justify-between py-4">
            <label for="list-qc-search" class="sr-only">Search</label>
            <div class="relative">
    ...
    <div class="relative">
        <div class="overflow-y-auto max-h-[550px]">
            <table id="list-qc" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
