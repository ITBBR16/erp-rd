    ...
    tambahExcludeBarangQcSecond.on('click', function () {
        ...
        <div id="exclude-barang-qc-${uniqueCount}" class="mt-4 grid md:grid-cols-5 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="exclude_kelengkapan_qc_additional[]" id="exclude_kelengkapan_qc_additional${uniqueCount}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="">
