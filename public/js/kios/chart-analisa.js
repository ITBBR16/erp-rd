document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById("analisa-profit-chart") && typeof ApexCharts !== 'undefined') {
        ...
        fetch('/kios/analisa/analisa-chart')
            ...
            .then(data => {
                ...
                const chart = new ApexCharts(document.getElementById("analisa-profit-chart"), options);
                chart.render();
            })
